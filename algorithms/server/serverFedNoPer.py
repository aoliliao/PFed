...
from algorithms.client.clientFedNoPer import clientFedoursNo
...
class FedOursNo(Server):
    def __init__(self, args, times):
        ...
        if args.dataset == 'digits' or args.dataset == 'office' or args.dataset == 'domainnet':
            self.set_clients_bn(args, clientObj=clientFedoursNo)
        else:
            self.set_clients(args, clientObj=clientFedoursNo)
    ...
    def set_clients_bn(self, args, clientObj):
        if args.dataset == "office":
            ...
            self.train_loaders, self.test_loaders, self.concat_test_dataloader = prepare_data_domainnet_customer(args,
                                                                                                                 datasets)
        # federated setting
